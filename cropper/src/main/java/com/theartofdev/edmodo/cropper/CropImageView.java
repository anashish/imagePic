...
public class CropImageView extends FrameLayout {
    ...
    private TextView txtVwFirstline = null;
    private TextView txtVwSecondLine =null;
    FrameLayout frameLayout;
    SharedPreferences prefs;
    private CropImageActivity cropImageActivity;
    ...
    public CropImageView(final Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        txtVwFirstline = (TextView) v.findViewById(R.id.txt_First);
        Typeface custom_font =Typeface.createFromAsset(getContext().getAssets(),"fonts/bradley_hand.ttf");
        txtVwFirstline.setTypeface(custom_font);
        txtVwSecondLine = (TextView) v.findViewById(R.id.txt_Second);
        Typeface custom_font1 = Typeface.createFromAsset(getContext().getAssets(), "fonts/bradley_hand.ttf");
        txtVwSecondLine.setTypeface(custom_font1);
...
*/
        ...
        frameLayout= (FrameLayout) findViewById(R.id.overlay_fragment_container);
        prefs = PreferenceManager.getDefaultSharedPreferences(context);
        if(prefs.getBoolean("isTutorialDone",false)) {

            frameLayout.setVisibility(View.GONE);
            txtVwFirstline.setVisibility(View.GONE);
            txtVwSecondLine.setVisibility(View.GONE);
        }
        ...
        frameLayout.setOnTouchListener(new View.OnTouchListener() {
                                           ...
                                           public boolean onTouch(View v, MotionEvent event) {
                                            prefs = PreferenceManager.getDefaultSharedPreferences(context);
                                           prefs.edit().putBoolean("isTutorialDone", true).commit();
                                           frameLayout.setVisibility(View.GONE);
                                           txtVwFirstline.setVisibility(View.GONE);
                                           txtVwSecondLine.setVisibility(View.GONE);
                                           // cropImageActivity.showActionbar();
                                               cropImageActivity.showActionbar();
    ...
    public boolean isTutorialDone(){
        return prefs.getBoolean("isTutorialDone",false);
    }
   // private AssetManager getAssets() {
    ...
    public void setActivity(CropImageActivity activity){
        this.cropImageActivity = activity;
    }
    /**
